...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '历史时代', // 您的昵称 例如 tangly1024  
  BIO: process.env.NEXT_PUBLIC_BIO || '一个历史爱好者，欢迎访问', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-three-nu-94.vercel.app', // 网站地址    
